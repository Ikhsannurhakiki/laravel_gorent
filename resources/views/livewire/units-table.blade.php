    ...
    <div class="bg-white p-6 rounded-xl shadow-md">
        @if ($units->isEmpty())
            <div class= "flex flex-justify justify-center">
                <div class="block">
                    <h2 class=" text-xl font-semibold">There is no unit</h2>
                    <h2 class="text-xl font-semibold">Add new one</h2>
                    <button x-on:click="Livewire.dispatch('openunitmodal', { businessId: {{ $business->id }} })"
                        class="group w-full md:w-auto flex items-center justify-center py-2.5 px-4 text-sm font-medium 
           bg-green-500 rounded-lg border border-transparent text-black 
           hover:bg-green-700 hover:text-white hover:border-black 
           focus:outline-none focus:ring-4 focus:ring-gray-200 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="5"
                            stroke="currentColor"
                            class="h-4 w-4 mr-2 text-black group-hover:text-white transition-colors">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex justify-end items-center space-x-4">
                    <form wire:submit="search">
                        <input type="text" wire:model="query" placeholder="Search units..."
                            class="border border-gray-300 focus:border-green-500 focus:ring focus:ring-green-200 rounded-lg px-3 py-2 w-72 outline-none transition">
                    </form>
                    <button x-on:click="Livewire.dispatch('openunitmodal', { businessId: {{ $business->id }} })"
                        class="group w-full md:w-auto flex items-center justify-center py-2.5 px-4 text-sm font-medium 
           bg-green-500 rounded-lg border border-transparent text-black 
