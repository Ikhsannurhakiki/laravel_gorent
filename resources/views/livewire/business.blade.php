...
<div id="createBusiness" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
            ...
            <form wire:submit.prevent="createBusiness" method="POST">
                ...
                <div class="flex justify-center space-x-2">
                    <button type="submit" class="bg-green-400 text-black px-5 py-2.5 rounded-lg">
            ...
            <div class="flex justify-center     space-x-2">
                <button type="submit" wire:click="createBusiness"
