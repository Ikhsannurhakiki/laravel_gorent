...
<div class="max-w-5xl bg-white shadow-md overflow-hidden p-6">
    <!-- Image carousel -->
    <div class="grid md:grid-cols-2 gap-3">
        ...
        <div class="relative">
            <img src='https://img.freepik.com/premium-photo/car-isolated-white-background-ford-focus-compact-car-white-car-blank-clean-whi-white-black_655090-717240.jpg'
                alt="Ford Focus" class="rounded-xl w-full object-cover">
            <div class="absolute inset-y-0 left-0 flex items-center justify-center w-10 bg-white/70 rounded-r-xl">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center justify-center w-10 bg-white/70 rounded-l-xl">
                <button class="text-gray-600 hover:text-blue-600">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-6 h-6">
    ...
    <div class="mt-6 grid md:grid-cols-2 gap-6">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="datetime-local" class="w-full border rounded-lg p-2 focus:ring-2 focus:ring-blue-500"
